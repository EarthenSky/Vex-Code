...
#pragma config(Sensor, dgtl3,  encElev,        sensorQuadEncoder)
...
void newCompAuto() {
	...
	drivingComplete = false; startMoveTask(34, dir_forwards, 0);  //FWD
  ...
  drivingComplete = false; startMoveTask(6, dir_forwards, SensorValue[gyro]);  //TODO: TUNING
    waitUntil(drivingComplete == true);  //wait for driving position reached
